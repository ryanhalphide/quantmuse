...
images) expose the **same 8 methods** — swap one for the other without
changing call sites. `RealTimeChartManager` buffers live ticks into a rolling
OHLCV window; `DashboardChartGenerator` composes multi-chart layouts.
